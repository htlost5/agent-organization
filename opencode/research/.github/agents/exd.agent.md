...
実験条件・評価指標の不確定要素を特定し、必要最小限の質問で解決します。
...
- 読取前に必ず `shared/context/project-index.md` および `research/project-index.md` を参照し、関連ファイルの候補を絞り込むこと
...
- 実験中に発見した未索引の重要ファイル・フォルダは、`_inbox/` 経由で `research/project-index.md` への追記を提案する
